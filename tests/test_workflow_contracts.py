...
class WorkflowContractTests(unittest.TestCase):
    ...
    def test_public_contract_versions_are_v6(self) -> None:
        ...
        self.assertEqual(manifest["business_type"], "contractor")
        self.assertEqual(manifest["contractor_profile"]["operating_model"], "not-confirmed")
        self.assertTrue((ROOT / "public" / "services.html").is_file())
